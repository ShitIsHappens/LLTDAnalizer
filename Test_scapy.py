...
class LltdAnalyzer:
    ...
    def send_probe_with_staff(self, who, src, dst, charge='t'):
    ...
    def cast(self, h1, h2):
        ...
        U1 = self.generate_unique_mac_adr()
        ...
        self.send_probe_with_staff(h1, U1, second_unique_mac)  # Probe1  h1: U1->U2
        ...
        self.send_probe_with_staff(h1, str(U3), h2)  # Probe2  h1: u1->h2
        for station in self.stations:
            if station != h1:
                self.send_probe_with_staff(station, station, h1, 'n')  # Probe3  h1: u2->u1
            ...
            if responder[QueryRecv].num_descs != 0:
                ...
                for QueryDesc in responder[QueryRecv].RecveeDescs:
                    ...
                    if QueryDesc.EthernetSource_Address == h2:
                        if QueryDesc.Ethernet_Destination_Address == U1:
    ...
    def discover(self):
        ...
        first_station = "00:01:6c:10:15:41"
        self.cast(first_station, "00:1f:d0:5b:0f:66")
